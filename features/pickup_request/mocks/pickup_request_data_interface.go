...
// PickupRequestDataInterface is an autogenerated mock type for the PickupRequestDataInterface type
type PickupRequestDataInterface struct {
	mock.Mock
}

// CreatePickupRequest provides a mock function with given fields: newData
func (_m *PickupRequestDataInterface) CreatePickupRequest(newData *pickuprequest.PickupRequest) (*pickuprequest.PickupRequest, error) {
...
func (_m *PickupRequestDataInterface) DeletePickupRequestByID(id int, userID uint) error {
...
func (_m *PickupRequestDataInterface) GetAllPickupRequest() ([]pickuprequest.PickupRequestInfo, error) {
	ret := _m.Called()
...
func (_m *PickupRequestDataInterface) GetPickupRequestByID(id int) (pickuprequest.PickupRequestInfo, error) {
	ret := _m.Called(id)
...
// NewPickupRequestDataInterface creates a new instance of PickupRequestDataInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewPickupRequestDataInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *PickupRequestDataInterface {
	mock := &PickupRequestDataInterface{}
	mock.Mock.Test(t)
